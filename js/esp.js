...
function atualizarContador() {
    // Define a data alvo
    const dataAlvo = new Date(2026, 8, 13, 10, 0, 0).getTime();
...
let cronograma = [
    {tipo: 'Treino 1', data: '11 SET', hora: '08:30', canal: 'Sportv | Globoplay | GE'},
    {tipo: 'Treino 2', data: '11 SET', hora: '12:00', canal: 'Sportv | Globoplay | GE'},
    {tipo: 'Treino 3', data: '12 SET', hora: '07:30', canal: 'Sportv | Globoplay | GE'},
    {tipo: 'Classificação', data: '12 SET', hora: '11:00', canal: 'Sportv | Globoplay | GE'},
    {tipo: 'Corrida', data: '13 SET', hora: '10:00', canal: 'Globo | Sportv | Globoplay | GE'}
]
...
let gridLargadaCorrida = [
    ...
    {nome: "Franco Colapinto", nacionalidade: " Argentina", equipe: "Alpine ", 
        link: "https://www.formula1.com/en/drivers/franco-colapinto", pos: '9', pts: ''},
            
    {nome: "Fernando Alonso", nacionalidade: "Espanha", equipe: "Aston Martin", 
        link: "https://www.formula1.com/en/drivers/fernando-alonso", pos: '18', pts: ''},
    ...
    {nome: "Yuki Tsunoda", nacionalidade: "França", equipe: "Racing Bulls", 
        link: "https://www.formula1.com/en/drivers/isack-hadjar", pos: '15'} 
    ];
...
let resultadoCorrida = [
    ...
    {nome: "Nico Hulkenberg", nacionalidade: "Alemanha", equipe: "Audi", 
        link: "https://www.formula1.com/en/drivers/nico-hulkenberg", pos:'10', pts: '1'},
    
    {nome: "Gabriel Bortoleto", nacionalidade: "Brasil", equipe: "Audi", 
        link: "https://www.formula1.com/en/drivers/gabriel-bortoleto", pos: '13', pts: '0'},
            
    {nome: "Sergio Perez", nacionalidade: "México", equipe: "Cadillac", 
        link: "https://www.formula1.com/en/drivers/sergio-perez", pos: '20', pts: 'NC | DNF'},
    ...
    {nome: "Lewis Hamilton", nacionalidade: "Inglaterra", equipe: "Ferrari", 
        link: "https://www.formula1.com/en/drivers/lewis-hamilton", pos: '22', pts: 'NC | DNF'},
            
    {nome: "Estaban Ocon", nacionalidade: "França", equipe: "Haas F1 Team", 
        link: "https://www.formula1.com/en/drivers/esteban-ocon", pos: '11', pts: '0'},
            
    {nome: "Oliver Bearman", nacionalidade: "Inglaterra", equipe: "Haas F1 Team", 
        link: "https://www.formula1.com/en/drivers/oliver-bearman", pos: '16', pts: '0'},
            
    {nome: "Lando Norris", nacionalidade: "Inglaterra", equipe: "McLaren", 
        link: "https://www.formula1.com/en/drivers/lando-norris", pos: '3', pts: '15'},
            
    {nome: "Oscar Piastri", nacionalidade: "Austrália", equipe: "McLaren", 
        link: "https://www.formula1.com/en/drivers/oscar-piastri", pos: '8', pts: '4'},
            
    {nome: "George Russell", nacionalidade: "Inglaterra", equipe: "Mercedes", 
        link: "https://www.formula1.com/en/drivers/george-russell", pos: '5', pts: '10'},
    ...
    {nome: "Carlos Sainz", nacionalidade: "Espanha", equipe: "Williams", 
        link: "https://www.formula1.com/en/drivers/carlos-sainz", pos: '19', pts: 'NC | DNF'},
            
    {nome: "Alexander Albon", nacionalidade: "Tailândia", equipe: "Williams", 
        link: "https://www.formula1.com/en/drivers/alexander-albon", pos: '15', pts: '0'},

    {nome: "Yuki Tsunoda", nacionalidade: "França", equipe: "Racing Bulls", 
        link: "https://www.formula1.com/en/drivers/isack-hadjar", pos: '14', pts: '0'} 
    ];
