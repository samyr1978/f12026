...
function atualizarContador() {
    // Define a data alvo
    const dataAlvo = new Date(2026, 8, 11, 8, 30, 0).getTime();
...
let cronograma = [
    {tipo: 'Treino 1', data: '11 SET', hora: '08:30', canal: ''},
    {tipo: 'Treino 2', data: '11 SET', hora: '12:00', canal: ''},
    {tipo: 'Treino 3', data: '12 SET', hora: '07:30', canal: ''},
    {tipo: 'Classificação', data: '12 SET', hora: '11:00', canal: ''},
    {tipo: 'Corrida', data: '13 SET', hora: '10:00', canal: ''}
]
