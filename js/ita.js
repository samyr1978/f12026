...
function atualizarContador() {
    // Define a data alvo
    const dataAlvo = new Date(2026, 8, 4, 7, 30, 0).getTime();
...
let cronograma = [
    {tipo: 'Treino 1', data: '04 SET', hora: '07:30', canal: 'Sportv | Globoplay | Ge '},
    {tipo: 'Treino 2', data: '04 SET', hora: '11:00', canal: 'Sportv | Globoplay | Ge'},
    {tipo: 'Treino 3', data: '05 SET', hora: '07:30', canal: 'Sportv | Globoplay | Ge'},
    {tipo: 'Classificação', data: '05 SET', hora: '11:00', canal: 'Sportv | Globoplay | Ge'},
    {tipo: 'Corrida', data: '06 SET', hora: '10:00', canal: 'Globo | Sportv | Globoplay | Ge'}
]
...
let gridLargadaCorrida = [
    {nome: "Pierre Gasly", nacionalidade: "França", equipe: "Alpine", 
        link: "https://www.formula1.com/en/drivers/pierre-gasly", pos: '1', pts: ''},
    ...
    {nome: "Estaban Ocon", nacionalidade: "França", equipe: "Haas F1 Team", 
        link: "https://www.formula1.com/en/drivers/esteban-ocon", pos: '16', pts: ''},
    ...
    {nome: "Lando Norris", nacionalidade: "Inglaterra", equipe: "McLaren", 
        link: "https://www.formula1.com/en/drivers/lando-norris", pos: '9', pts: ''},
    ...
    {nome: "Kimi Antonelli", nacionalidade: "Itália", equipe: "Mercedes", 
        link: "https://www.formula1.com/en/drivers/kimi-antonelli", pos: '7', pts: ''},
    ...
    {nome: "Alexander Albon", nacionalidade: "Tailândia", equipe: "Williams", 
     ...
     {nome: "Yuki Tsunoda", nacionalidade: "França", equipe: "Racing Bulls", 
        link: "https://www.formula1.com/en/drivers/isack-hadjar", pos: '17'}        
    ];
...
let resultadoCorrida = [
    ...
    {nome: "Fernando Alonso", nacionalidade: "Espanha", equipe: "Aston Martin", 
        link: "https://www.formula1.com/en/drivers/fernando-alonso", pos: '21', pts: 'NC | DNF'},
    ...
    {nome: "Sergio Perez", nacionalidade: "México", equipe: "Cadillac", 
        link: "https://www.formula1.com/en/drivers/sergio-perez", pos: '18', pts: '0'},
            
    {nome: "Valteri Bottas", nacionalidade: "Finlândia", equipe: "Cadillac", 
        link: "https://www.formula1.com/en/drivers/valtteri-bottas", pos: '19', pts: '0'},
            
    {nome: "Charles Leclerc", nacionalidade: "Monaco", equipe: "Ferrari", 
        link: "https://www.formula1.com/en/drivers/charles-leclerc", pos: '22', pts: 'NC | DNF'},
    ...
    {nome: "Yuki Tsunoda", nacionalidade: "França", equipe: "Racing Bulls", 
        link: "https://www.formula1.com/en/drivers/isack-hadjar", pos: '10', pts: '1'}     
    ];
