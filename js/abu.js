...
function atualizarContador() {
    // Define a data alvo
    const dataAlvo = new Date(2026, 11, 4, 6, 30, 0).getTime();
...
let cronograma = [
    {tipo: 'Treino 1', data: '04 DEZ', hora: '06:30', canal: ''},
    {tipo: 'Treino 2', data: '04 DEZ', hora: '10:00', canal: ''},
    {tipo: 'Treino 3', data: '05 DEZ', hora: '07:30', canal: ''},
    {tipo: 'Classificação', data: '05 DEZ', hora: '11:00', canal: ''},
    {tipo: 'Corrida', data: '06 DEZ', hora: '10:00', canal: ''}
]
