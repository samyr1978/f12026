...
function atualizarContador() {
    // Define a data alvo
    const dataAlvo = new Date(2026, 10, 6, 12, 30, 0).getTime();
...
let cronograma = [
    {tipo: 'Treino 1', data: '06 NOV', hora: '12:30', canal: ''},
    {tipo: 'Treino 2', data: '06 NOV', hora: '16:00', canal: ''},
    {tipo: 'Treino 3', data: '07 NOV', hora: '11:30', canal: ''},
    {tipo: 'Classificação', data: '07 NOV', hora: '15:00', canal: ''},
    {tipo: 'Corrida', data: '08 NOV', hora: '14:00', canal: ''}
]
