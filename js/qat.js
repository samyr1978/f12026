...
function atualizarContador() {
    // Define a data alvo
    const dataAlvo = new Date(2026, 10, 27, 10, 30, 0).getTime();
...
let cronograma = [
    {tipo: 'Treino 1', data: '27 NOV', hora: '10:30', canal: ''},
    {tipo: 'Treino 2', data: '27 NOV', hora: '14:00', canal: ''},
    {tipo: 'Treino 3', data: '28 NOV', hora: '11:30', canal: ''},
    {tipo: 'Classificação', data: '28 NOV', hora: '15:00', canal: ''},
    {tipo: 'Corrida', data: '29 NOV', hora: '13:00', canal: ''}
]
