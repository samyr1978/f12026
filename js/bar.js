...
function atualizarContador() {
    // Define a data alvo
    const dataAlvo = new Date(2026, 5, 14, 10, 0, 0).getTime();
...
let cronograma = [
    {tipo: 'Treino 1', data: '12 JUN', hora: '08:30', canal: 'Sportv | Globoplay | GE'},
    {tipo: 'Treino 2', data: '12 JUN', hora: '12:00', canal: 'Sportv | Globoplay | GE'},
    {tipo: 'Treino 3', data: '13 JUN', hora: '07:30', canal: 'Sportv | Globoplay | GE'},
    {tipo: 'Classificação', data: '13 JUN', hora: '11:00', canal: 'Sportv | Globoplay | GE'},
    {tipo: 'Corrida', data: '14 JUN', hora: '10:00', canal: 'Globo | Sportv | Globoplay | GE'}
]

// Cronograma
function funcTabelaCronograma() {
    const corpo = document.getElementById('corpoTabelaCronograma');
    const finalizados = ['Treino 1', 'Treino 2', 'Treino 3', 'Classificação'] // Inserir aqui as etapas finalizadas. ex: Treino 1        
...
let gridLargadaCorrida = [
    ...
    {nome: "Nico Hulkenberg", nacionalidade: "Alemanha", equipe: "Audi", 
        link: "https://www.formula1.com/en/drivers/nico-hulkenberg", pos:'9', pts: ''},
    ...
    {nome: "Charles Leclerc", nacionalidade: "Monaco", equipe: "Ferrari", 
        link: "https://www.formula1.com/en/drivers/charles-leclerc", pos: '10', pts: ''},
    ...
    {nome: "Kimi Antonelli", nacionalidade: "Itália", equipe: "Mercedes", 
        link: "https://www.formula1.com/en/drivers/kimi-antonelli", pos: '3', pts: ''},
            
    {nome: "Liam Lawson", nacionalidade: "Nova Zelândia", equipe: "Racing Bulls", 
        link: "https://www.formula1.com/en/drivers/liam-lawson", pos: '8', pts: ''},
            
    {nome: "Arvid Lindblad", nacionalidade: "Inglaterra", equipe: "Racing Bulls", 
        link: "https://www.formula1.com/en/drivers/arvid-lindblad", pos: '11', pts: ''},
    ...
    {nome: "Isack Hadjar", nacionalidade: "França", equipe: "Red Bull Racing", 
        link: "https://www.formula1.com/en/drivers/isack-hadjar", pos: '6', pts: ''},
...
let resultadoCorrida = [
    ...
    {nome: "Fernando Alonso", nacionalidade: "Espanha", equipe: "Aston Martin", 
        link: "https://www.formula1.com/en/drivers/fernando-alonso", pos: '19', pts: 'NC | DNF'},
            
    {nome: "Lance Stroll", nacionalidade: "Canadá", equipe: "Aston Martin", 
        link: "https://www.formula1.com/en/drivers/lance-stroll", pos: '22', pts: 'NC | DNF'},
    ...
    {nome: "Charles Leclerc", nacionalidade: "Monaco", equipe: "Ferrari", 
        link: "https://www.formula1.com/en/drivers/charles-leclerc", pos: '15', pts: 'NC | DNF'},
            
    {nome: "Lewis Hamilton", nacionalidade: "Inglaterra", equipe: "Ferrari", 
        link: "https://www.formula1.com/en/drivers/lewis-hamilton", pos: '1', pts: '25'},
            
    {nome: "Estaban Ocon", nacionalidade: "França", equipe: "Haas F1 Team", 
        link: "https://www.formula1.com/en/drivers/esteban-ocon", pos: '13', pts: '0'},
            
    {nome: "Oliver Bearman", nacionalidade: "Inglaterra", equipe: "Haas F1 Team", 
        link: "https://www.formula1.com/en/drivers/oliver-bearman", pos: '17', pts: 'NC | DNF'},
            
    {nome: "Lando Norris", nacionalidade: "Inglaterra", equipe: "McLaren", 
        link: "https://www.formula1.com/en/drivers/lando-norris", pos: '3', pts: '15'},
    ...
    {nome: "Kimi Antonelli", nacionalidade: "Itália", equipe: "Mercedes", 
        link: "https://www.formula1.com/en/drivers/kimi-antonelli", pos: '16', pts: 'NC | DNF'},
    ...
    {nome: "Max Verstappen", nacionalidade: "Holanda", equipe: "Red Bull Racing", 
        link: "https://www.formula1.com/en/drivers/max-verstappen", pos: '4', pts: '12'},
