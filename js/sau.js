...
function atualizarContador() {
    // Define a data alvo
    const dataAlvo = new Date(2026, 3, 17, 10, 30, 0).getTime();
...
let cronograma = [
    {tipo: 'Treino 1', data: '17 ABR', hora: '10:30', canal: ''},
    {tipo: 'Treino 2', data: '17 ABR', hora: '14:00', canal: ''},
    {tipo: 'Treino 3', data: '18 ABR', hora: '10:30', canal: ''},
    {tipo: 'Classificação', data: '18 ABR', hora: '14:00', canal: ''},
    {tipo: 'Corrida', data: '19 ABR', hora: '14:00', canal: ''}
]
