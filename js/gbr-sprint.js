...
function atualizarContador() {
    // Define a data alvo
    const dataAlvo = new Date(2026, 6, 3, 8, 30, 0).getTime();
...
let cronograma = [
    {tipo: 'Treino 1', data: '03 JUL', hora: '08:30', canal: ''},
    {tipo: 'Classificação Sprint', data: '03 JUL', hora: '12:30', canal: ''},
    {tipo: 'Sprint', data: '04 JUL', hora: '08:00', canal: ''},
    {tipo: 'Classificação', data: '04 JUL', hora: '12:00', canal: ''},
    {tipo: 'Corrida', data: '05 JUL', hora: '11:00', canal: ''}
]
...
let resultadoSprint = [
    ...
    {nome: "Oscar Piastri", nacionalidade: "Austrália", equipe: "McLaren", 
        link: "https://www.formula1.com/en/drivers/oscar-piastri", pos: '1pos', pts: ''},
