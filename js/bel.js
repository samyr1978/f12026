...
function atualizarContador() {
    // Define a data alvo
    const dataAlvo = new Date(2026, 6, 17, 8, 30, 0).getTime();
...
let cronograma = [
    {tipo: 'Treino 1', data: '17 JUL', hora: '08:30', canal: ''},
    {tipo: 'Treino 2', data: '17 JUL', hora: '12:00', canal: ''},
    {tipo: 'Treino 3', data: '18 JUL', hora: '07:30', canal: ''},
    {tipo: 'Classificação', data: '18 JUL', hora: '11:00', canal: ''},
    {tipo: 'Corrida', data: '19 JUL', hora: '10:00', canal: ''}
]
